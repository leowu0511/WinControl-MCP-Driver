...
# ============================================================
print("\n=== SS-1: 截圖壓縮常數已設定 ===")
expect(wcmd_config.SCREENSHOT_MAX_WIDTH, 1280, "最大寬度 = 1280")
expect(wcmd_config.SCREENSHOT_JPEG_QUALITY, 60, "JPEG quality = 60")

print("\n=== SS-2: screenshot_format 已改為 jpeg ===")
expect(engine.encode_image_to_base64.__doc__, engine.encode_image_to_base64.__doc__,
            "encode_image_to_base64 仍是向後相容的舊版函式")
expect_true("JPEG" in str(engine.encode_compressed_screenshot.__doc__),
            "encode_compressed_screenshot 註解提到 JPEG")
...
# 編碼
b64 = engine.encode_compressed_screenshot(str(test_path))
...
b64_small = engine.encode_compressed_screenshot(str(test_path_small))
...
# 編碼
b64 = engine.encode_compressed_screenshot(str(DATA_DIR / "test_realistic_4k.png"))
b64_size_kb = len(b64) / 1024
